...
public class FavoriteMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv_favorite_movie = (ListView) rootView.findViewById(R.id.lv_favorite_movie);
        ...
        TodoCursorAdapter todoAdapter = new TodoCursorAdapter(getActivity(), cursor);

        // Attach cursor adapter to the ListView
        lv_favorite_movie.setAdapter(todoAdapter);
    ...
    private Cursor getAllFavoriteMovie() {
        return mDb.query(
                FavoriteMovie.FavoriteMovieEntry.TABLE_NAME,
                null,
                null,
                null,
                null,
                null,
                FavoriteMovie.FavoriteMovieEntry._ID
        );
    }
}
